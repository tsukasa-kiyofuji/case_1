	...
	<header>
        <content>
        	<div class="header_main">
        		<ul>
        			<li><a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/image/header/header-logo.svg" class="header_logo_1"></a></li>
        		</ul>
        		<ul>
	        		<li><a href="">会社を知る</a></li>
	        		<li><a href="">仕事を知る</a></li>
	        		<li><a href="">人を知る</a></li>
	        		<li><a href="">環境を知る</a></li>
	        		<li><a href="">採用について</a></li>
	        		<li><a href="">募集職種<span class="tri_1"></span></a></li>
        		</ul>
        	</div>
        <!-- hover時、出現のヘッダーサブカテ -->
        	<nav class="header_main_sub">
        		<ul>
        			<p class="space_1"></p>
        			<li><a href="<?php echo home_url('/company'); ?>"><span>・</span>会社概要</a></li>
        			<li><a href="<?php echo home_url('/topmessage'); ?>"><span>・</span>トップメッセージ</a></li>
        		</ul>
        		<ul>
        			<p class="space_2"></p>
        			<div>
	        			<li><a href="<?php echo home_url('/creative'); ?>"><span>・</span>クリエイティブ</a></li>
	        			<li><a href="<?php echo home_url('/customercare'); ?>"><span>・</span>カスタマーケア・審査・モニタリング</a></li>
	        			<li><a href="<?php echo home_url('/service'); ?>"><span>・</span>サービス運営</a></li>
	        			<li><a href="<?php echo home_url('/it'); ?>"><span>・</span>社内IT・コーポレート</a></li>
	        		</div>
	        		<div>
	        			<li><a href="<?php echo home_url('/test'); ?>"><span>・</span>テスト</a></li>
	        			<li><a href="<?php echo home_url('/sales'); ?>"><span>・</span>セールス・マーケティング</a></li>
	        			<li><a href="<?php echo home_url('/project'); ?>"><span>・</span>企画・管理</a></li>
        			</div>
        		</ul>
        		<ul>
        			<p class="space_3"></p>
        			<li><a href=""><span>・</span>社員インタビュー</a></li>
        			<li><a href=""><span>・</span>ブログ<img src="<?php echo get_template_directory_uri(); ?>/image/header/icon_arrow-right-up.svg" class="arrow_1"></a></li>
        			<li><a href=""><span>・</span>150COLOR<img src="<?php echo get_template_directory_uri(); ?>/image/header/icon_arrow-right-up.svg" class="arrow_1"></a></li>
        		</ul>
        		<ul>
        			<p class="space_1"></p>
        			<li><a href="<?php echo home_url('/environment'); ?>"><span>・</span>福利厚生・制度</a></li>
        			<li><a href="<?php echo home_url('/environment'); ?>#sticky_office"><span>・</span>オフィス環境</a></li>
        		</ul>
        		<ul>
        			<p class="space_1"></p>
        			<li><a href=""><span>・</span>募集職種検索</a></li>
        			<li><a href="<?php echo home_url('/question'); ?>"><span>・</span>よくある質問</a></li>
        		</ul>
        	</nav>
        </content>
    <!-- scroll時、出現のヘッダー	 -->
        ...
        <div class="header_responsive">
			...
			<nav class="globalMenuSp">
	    		<ul>
	        		...
	        		<li class="ham_list_last"><a href="">募集職種<span class="tri_1"></span></a></li>
	    		</ul>
			</nav>
        </div>
	</header>
    	...
    	<section id="top-wrapper">
    		<content>
    			<div>
    				...
    				<nav>
    					<a href=""><img src="<?php echo get_template_directory_uri(); ?>/image/top-wrapper/top_2.png" class="color150"></a>
	    				<nav class="cross_btn">
						    <span></span>
						    <span></span>
						</nav>
